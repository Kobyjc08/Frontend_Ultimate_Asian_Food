...
const AsianTraditionalFood = () => {
  ...
  useEffect(() => {
    axios.get("http://localhost:3001/productsByCategory/Asian").then(function (response) {
  ...
  return (
    <Layout>
      ...
      <Breadcrumb>
          ...
          <Breadcrumb.Item active>Desserts</Breadcrumb.Item>
        </Breadcrumb>
        <h3 className="red-letters">
        - Feel at home with the flavors of our traditional Asian cuisine! -</h3>
